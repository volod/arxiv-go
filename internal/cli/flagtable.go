...
var flagTable = []flagDef{
	...
	{name: "sample-resolution", ops: splitOnly, group: groupSplit, stage: 2, arg: "RES", usage: "sd, hd or 4k upper bound", bind: reserved(false)},
	{name: "sample-quality", ops: splitOnly, group: groupSplit, stage: 2, arg: "Q", usage: "low, medium, high", bind: reserved(false)},
	{name: "image", ops: splitOnly, group: groupSplit, stage: 2, arg: "MODE", usage: "Frame images: none, start, middle, end, series", bind: reserved(false)},
	{name: "image-every", ops: splitOnly, group: groupSplit, stage: 2, arg: "DURATION", usage: "Frame spacing for series", bind: reserved(false)},
	{name: "image-resolution", ops: splitOnly, group: groupSplit, stage: 2, arg: "RES", usage: "sd, hd or 4k upper bound", bind: reserved(false)},
	{name: "image-quality", ops: splitOnly, group: groupSplit, stage: 2, arg: "Q", usage: "PNG compression: low, medium, high", bind: reserved(false)},
	{name: "preview-max-items", ops: splitOnly, group: groupSplit, stage: 2, arg: "N", usage: "Cap on fragments per series clip and frames per series", bind: reserved(false)},
