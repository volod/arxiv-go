...
// split_recovery.go, split_description.go and split_report.go (payload transactions, descriptions
// and registries), payload_catia.go and text.go (CATIA split and post-commit text sidecars),
// restore.go, restore_exec.go, restore_recovery.go, restore_dirs.go and restore_report.go (restore
// transactions), previews_index.go, previews_plan.go, previews_exec.go and previews_restore.go
// (preview WAL events, planning, generation and cleanup).
// Specifications: docs/openspec/stage-1-core/integrity.md,
// docs/openspec/stage-1-core/split-restore.md, docs/openspec/stage-2-previews/previews.md and
// docs/openspec/stage-4-catia/split-restore.md.
package archive
