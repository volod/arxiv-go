...
| [Media previews](current/media-previews.md) | ffmpeg runner, process supervision, progress, part-file publication, encoder probe and pure preview planning | Planner and typed split flags available; generation integration remains |
