...
| [Media previews](current/media-previews.md) | ffmpeg runner, pure planning, sample encoding and PNG frame extraction | Executors and typed split flags available; archive integration remains |
