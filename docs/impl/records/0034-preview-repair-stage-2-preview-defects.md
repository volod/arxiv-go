...
- Amendments: the review's declared run on real operator media
  ...
  operator's request during the review to scan a representative media archive (path omitted) and
  check that every video format it holds is supported, found four more defects that
