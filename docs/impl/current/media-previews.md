...
A read-only survey of an archive (666 video files, 333 GiB) and a split, rerun and
...
(first with FFmpeg 6.1.1, again on the copy with the pinned 9.0.1). GoPro and phone data
